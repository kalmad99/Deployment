...
func TestAdminCategories(t *testing.T) {
	...
	mux.HandleFunc("/admin/categories", AdminCategories)
...
func TestAdminCategoriesNew(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.HandleFunc("/admin/categories/new", AdminCategories)
	ts := httptest.NewTLSServer(mux)
	defer ts.Close()
...
func TestAdminCategoresUpdate(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.HandleFunc("/admin/categories/update", AdminCategories)
	ts := httptest.NewTLSServer(mux)
	defer ts.Close()
...
func TestAdminCategoresDelete(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.HandleFunc("/admin/categories/delete", AdminCategories)
	ts := httptest.NewTLSServer(mux)
	defer ts.Close()
