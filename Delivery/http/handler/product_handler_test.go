...
func TestSellerProduct(t *testing.T) {
	...
	mux.HandleFunc("/seller/products", SellerProducts)
...
func TestproductCategoriesNew(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.HandleFunc("/seller/products/new", SellerProducts)
	ts := httptest.NewTLSServer(mux)
	defer ts.Close()
...
func TestSellerProductsUpdate(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.HandleFunc("/seller/products/update", SellerProducts)
	ts := httptest.NewTLSServer(mux)
	defer ts.Close()
...
func TestSellerProductsDelete(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.HandleFunc("/seller/products/delete", SellerProducts)
	ts := httptest.NewTLSServer(mux)
	defer ts.Close()
...
func TestSearchProducts(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.HandleFunc("/searchProducts", SellerProducts)
	ts := httptest.NewTLSServer(mux)
	defer ts.Close()
...
func TestProductDetail(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.HandleFunc("/detail", SellerProducts)
	ts := httptest.NewTLSServer(mux)
	defer ts.Close()
